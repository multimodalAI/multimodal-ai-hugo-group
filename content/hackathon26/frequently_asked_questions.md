...
### Do I need to attend the MultimodalAI’26 workshop?
...
### When does the hackathon registration close?
...
No. Solo participants are welcome. Team formation will take place from **10:20 to 10:30** on the day. You may also arrange a team in advance through the UKOMAIN Discord channel. To join the UKOMAIN Discord channel, please [click here](https://discord.gg/HB7NNMTmuh). 

### How do I find teammates before the hackathon?
...
### Do I need to introduce myself on Discord before arriving?
...
* Follow the setup instructions in the starter kit sent on **4 June**.
* Bring a laptop with **Python 3.11+** installed.
* Install any IDE or code editor of your choice.
* Create a GitHub account if you do not already have one.
* Confirm that your setup runs correctly before arrival.

### What if I have never used an IDE before?
...
* A GitHub account.
* Any chargers or accessories you need.
...
### Are participants expected to use the provided AI models, or can they use their own?
...
### Do I need to have a problem or idea ready before I arrive?
...
* someone comfortable with Python or technical analysis;
* someone with relevant domain knowledge;
* someone who can write clearly for non-technical audiences.

### Can I join more than one team or work on more than one strand?

No. Each participant must join one team and work on one strand for the full day.

### I am a clinician, housing officer, or domain specialist with no coding background. What is my role?
